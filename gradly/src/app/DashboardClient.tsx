  ...
  return (
    <div className="mb-12 w-full max-w-5xl px-4">
      ...
      <h2 className="text-5xl font-bold tracking-tight text-white uppercase">
        {line1}
        <span className="inline-block w-1.5 h-10 bg-green-500 ml-3 animate-pulse align-middle" />
      </h2>
      <div
...
function InfoModule({
  ...
  return (
    <div className="flex flex-col items-center justify-center w-72 h-56 border-x border-gray-900 px-10">
      <span className="text-[10px] text-gray-600 tracking-[0.5em] uppercase mb-8">
        {label}
      </span>
      ...
      <div className="mt-10 w-16 h-px bg-gray-800" />
    </div>
  );
}
...
function CircularProgress({
  ...
  return (
    <div className="flex flex-col items-center gap-8">
      ...
      <span className="text-[10px] text-gray-500 tracking-[0.6em] uppercase border-t border-gray-900 pt-8 w-full text-center">
        {label}
      </span>
    </div>
  );
